...
if (fs.existsSync(manifestPath)) {
  ...
  for (const key of ['AZURE_SUBSCRIPTION_ID', 'AZURE_RESOURCE_GROUP', 'AZURE_ENV_NAME', 'ENTRA_TENANT_ID', 'ENTRA_SPA_APP_ID', 'ENTRA_API_APP_ID']) {
...
if (fs.existsSync(localEnvironmentPath)) {
  ...
  fs.writeFileSync(temporaryPath, updateEnvironmentText(fs.readFileSync(localEnvironmentPath, 'utf8'), cleared), { mode: 0o600 });
